...
class BookingController extends Controller
{
    ...
    public function cart_submit(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Room is added to booking successfully.');
    }
    ...
    public function cart_delete($id)
    {
        ...
        return redirect()->back()->with('success', 'Booking item is deleted.');
    ...
    public function checkout()
    {
        ...
        if(!session()->has('cart_room_id')) {
            return redirect()->back()->with('error', 'No room booking added!');
        }
    ...
    public function paypal($final_price)
    {
        ...
        if($result->state == 'approved')
        {
            ...
            $message .= '<br>Booking No: '.$order_no;
