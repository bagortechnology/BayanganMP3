...
class AdminLoginController extends Controller
{
    ...
    public function forget_password_submit(Request $request)
    {
        ...
        return redirect()->route('admin_login')->with('success','Please check your email and follow the steps to reset your password!');
    ...
    public function login_submit(Request $request)
    {
        ...
        if(Auth::guard('admin')->attempt($credential)) {
            ...
            return redirect()->route('admin_login')->with('error', 'Sorry the email or password is NOT correct!');
        }
    }
