<div class="navbar-bg pb-3"></div>
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right btn-block justify-content-end">
                <li class="nav-link">
                    <a href="{{ route('home') }}" target="_blank" class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i> View Website</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item text-danger" href="{{ route('admin_logout') }}"><i class="fa fa-sign-out"></i> Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>